...
public class BaseClass extends ActionBarActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fgColor[0] = getResources().getColor(R.color.Blue);
        fgColor[1] = getResources().getColor(R.color.Green);
    ...
    public class CustomDialog extends Dialog {
        ...
        public CustomDialog(Context context, int theme) {
            ...
            dialogWindow.setBackgroundDrawable(new ColorDrawable(getResources().getColor(R.color.Red)));
